                  ...
                  children: <Widget>[
                    new Expanded(
                      child: new TextButton(
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(this.highlightColor),
                        ),
                        onPressed: () => {},
                        child: Text(
                          "Log In",
                ...
                child: new Row(
                  children: <Widget>[
                    new Expanded(
                      child: new TextButton(
                        style: ButtonStyle(
                          foregroundColor: MaterialStateProperty.all(this.foregroundColor),
                        ),
                        onPressed: () => {},
                        child: Text(
                ...
                child: new Row(
                  children: <Widget>[
                    new Expanded(
                      child: new TextButton(
                        style: ButtonStyle(
                          foregroundColor: MaterialStateProperty.all(this.foregroundColor!.withOpacity(0.5)),
                        ),
                        onPressed: () => {},
                        child: Text(
